...
inline BOOL _print_error(const char* func, int line, char* msg, HRESULT hr) {
#ifdef BOF
...
inline BOOL _print_point(const char* func, int line, char* msg, PVOID hr) {
#ifdef BOF
...
inline BOOL _print_msg(const char* func, int line, char* msg) {
#ifdef BOF
